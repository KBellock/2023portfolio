  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.item}>
        ...
        <p className={styles.desc}>Hello there, I'm Kevin Bellock, and I'm thrilled to connect with you. As a dedicated Software Engineer specializing in Web Development with a focus on React, I'm here to turn your digital dreams into reality. With each line of code I write, I'm driven by a passion for creating seamless and captivating user experiences that leave a lasting impression.<br /><br />

My journey in the world of technology began with a strong foundation in Information Technology, where I fine-tuned my problem-solving skills and gained a deep understanding of system architecture and network infrastructure. This background uniquely positions me to craft robust and efficient web solutions that not only look great but also function flawlessly under the hood.<br /><br />

But what truly sets me apart is my commitment to customer service. I understand that technology is ultimately about people, and I bring this mindset into every project. I believe in clear communication, collaborative teamwork, and going that extra mile to ensure your vision is not only met but exceeded. So whether you're a startup with a bold idea or an established business looking to enhance your online presence, I'm here to partner with you and make it happen. Let's turn your ideas into a digital masterpiece together.</p>
      </div>
      <div className={styles.item}>
        <h2 className={styles.title}>Why Get A Custom Website?</h2>
        <p className={styles.desc}>Imagine a dynamic and high-performing online presence that seamlessly engages your audience and drives your business forward. That's precisely what a Next.js website coupled with a headless CMS and MongoDB can offer your business.
...
Now, let's talk about MongoDB – a powerful and flexible NoSQL database. MongoDB's document-based structure allows for seamless scalability, ensuring your website can effortlessly handle increasing amounts of data and traffic. This scalability translates to a more reliable and responsive user experience, even during traffic spikes or rapid growth periods. Additionally, MongoDB's ability to handle diverse data types enables you to efficiently store and retrieve various content elements, from images and videos to complex product data.<br /><br />

In summary, a Next.js website with a headless CMS and MongoDB is a game-changer for your business. It brings speed, SEO optimization, and responsive design to the forefront, enhancing user experiences and driving conversions. The streamlined content management process accelerates your team's efficiency, while MongoDB's scalability ensures your website remains robust and reliable as your business flourishes. It's a powerful combination that empowers your business to thrive in the digital landscape.</p>
      </div>
      </div>
    </div>
  )
